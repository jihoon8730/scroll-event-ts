...
const getHorizontalElements = () => {
    const section = document.querySelector("[data-horizontal-section]");
    const track = section?.querySelector("[data-horizontal-track]");
    const title = section?.querySelector("[data-active-title]");
    const description = section?.querySelector("[data-active-description]");
    const link = section?.querySelector("[data-active-link]");
    ...
    const groups = Array.from(track.querySelectorAll(".card-group"));
